...
import BabyTracker from "@/components/Home/BabyTracker";
import CommunitySpotlight from "@/components/Home/CommunitySpotlight";
import NearbyEvent from "@/components/Home/NearbyEvent";
...
const Index = () => {
  ...
  return (
    <>
      ...
      <View className="pb-12 relative px-0 flex-1">
        {/* Header Start */}
        <View className="pt-16 bg-[#7C0A64] z-10 pb-6 rounded-b-3xl flex flex-row gap-3 items-center">
          <View className="px-6">
            <TouchableOpacity
        ...
        <ScrollView className="max-h-[90vh]" refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh}/>}>
